  ...
  return (
    <Box>
      <Box
        ...
        alignItems="center"
        sx={{ marginTop: { xs: "200px", sm: "180px", md: "100px" } }}
      >
          ...
          <Box flexBasis={{ xs: "100%", md: "80%" }}>
            ...
            <Card>
              ...
              <Paper
                sx={{
                  position: "absolute",
                  right: { xs: "30%", sm: "30%", md: "25%" },
                  top: { xs: "90%", sm: "90%", md: "95%" },
                  width: { xs: "30%", sm: "30%", md: "20%" },
                  height: { xs: "3%", sm: "3%", md: "10%" },
              ...
              <Paper
                sx={{
                  position: "absolute",
                  right: { xs: "10%", sm: "10%", md: "20%" },
                  top: { xs: "100%", sm: "110%", md: "125%" },
                  width: { xs: "70%", sm: "70%", md: "30%" },
                  height: { xs: "15%", sm: "10%", md: "20%" },
                  backgroundColor: "rgba(255, 255, 255, 0.7)",
                  p: 2,
                }}
              >
